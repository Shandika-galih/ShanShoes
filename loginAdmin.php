...
<html lang="en">
  <head>
    ...
    <meta name="author" content="Shandika Galih N.A">
    <link rel="icon" href="../../favicon.ico">

    <title>Admin ShanShoes | Toko Sepatu Online telengkap dan terpercaya</title>
...
<!-- role="form" -->
      <form class="form-signin" method="post" action="proseslogin.php">
        <h2 class="form-signin-heading"><center><span class="glyphicon glyphicon-th-large"></span> Welcome Admin ShanShoes</center></h2>
        <h5 class="baru">Login To Admin ShanShoes</h5>
